...
namespace program2
{
    partial class Form1
    {
        ...
        private  static String connetStr = "server=127.0.0.1;port=3306;user=root;password=anjiaxin123; database=base1;";
        private MySqlConnection conn = new MySqlConnection(connetStr);
